...
-- Tiempo de generación: 22-01-2024 a las 04:28:42
...
) ENGINE=InnoDB AUTO_INCREMENT=95 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci COMMENT='	';
...
(94, 94, 1, '1', 'KIOSCO', '1', '9', 0, '5', 'A', '2024-01-21 18:22:32', '0000-00-00 00:00:00');
...
(6, 1, 6, 'C', 'A', '', 1, '2024-01-12'),
(7, 1, 7, 'C', 'A', '', 1, '2024-01-13');
...
(63, 1, 7, '		Sacos de leña', 6, 3333, '2024-01-13');
...
(3, '1', '7801610382028', 'Agua tónica schweppes', '2', '9', 1, 'N', 1, '1379', 45, 621, '2000', 0, 'S', '1', '2023-12-22'),
...
(26, '1', '7804624850033', 'Carbón Lider 2.5KG', '2', '11', 10, 'N', 1, '3200', 56, 1800, '5000', 0, 'S', '1', '2023-12-22'),
...
(34, '1', '7613032186852', 'Helado Chocolito', '1', '12', 100, 'N', 1, '589', 36, 211, '800', 0, 'S', '1', '2023-12-30'),
...
(37, '1', '78006140', 'Helado Crocanty', '1', '12', 20, 'N', 1, '589', 36, 211, '800', 0, 'S', '1', '2023-12-30'),
...
CREATE TABLE IF NOT EXISTS `ventas` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=201 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci COMMENT='								';
