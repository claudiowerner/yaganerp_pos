...
require("../../../../vendor/fpdf/fpdf.php");
    ...
    $pdf->Cell(60,4,utf8_decode('Cuenta'),0,11,"C");
    $pdf->Cell(40,1,utf8_decode('-----------------------------------------'),0,1,"L");
    ...
    JOIN productos p ON p.id_prod = v.producto WHERE v.id_cl = 1 AND v.id_venta = $folio AND v.mesa = '$nMesa' ORDER BY v.id ASC";
