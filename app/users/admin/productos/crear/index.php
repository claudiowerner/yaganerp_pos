...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      {
        echo '<h1>Categorías: Modificando</h1>';
      }
      else
        {
          echo '<h1>Categorías: Agregando...</h1>';
        }
      ?>
      <table id="countries" class="table">
        <tr>
            ...
            if(isset($_GET['id']))
            {
              $sql= "SELECT * FROM categorias WHERE id_cl = '$id_cl' and id=".$_GET['id'];
              $resultado= mysqli_query($conexion, $sql);
              while($row=mysqli_fetch_array($resultado))
              {
                echo "<td> <span id='idCat'>".$row['id']."</span><br><label name='nombreCat'>Nombre</label></td><td>";
                echo "<br><input type='text' name='nomCat' id='nomCat' class='form-control' value=".$row['nombre_cat'].">";
                if($row['estado']=='S')
                {
                  echo "</td>
                    ...
                    <tr>
                      ...
                      <td>
                        <select id='estadoCat' class='form-control'>
                          ...
                          <option value='N' selected>Desactivado</option>
                        </select>
                      </td>
                    </tr>";
                }
            ...
            {echo "<td><label name='nombreCat'>Nombre</label></td><td>";
              echo "<input type='text' name='nomCat' id='nomCat' class='form-control'></td>
        ...
        <tr>
          <td>
            ...
            if(isset($_GET['id']))
            {
              echo '<button class="btn btn-success" id="btnModificar">Modificar</button>';
            }
            else
            {
              echo '<button class="btn btn-success" id="btnGuardarCat">Guardar</button>';
            }
