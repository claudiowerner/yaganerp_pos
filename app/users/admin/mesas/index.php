                            ...
                            <div class="col-md-12">
                                <div class="card card-warning" id="${task.id}">
                                    ...
                                    <?php
                                        ...
                                        <h1>Mesas</h1>
                                        <button type="button" class="btn btn-success" id="btnAgregarMesa">Agregar mesa</button>
                                        <table id="mesas" class="table table-bordered table-hover dt-resposive display nowrap">
                                            <thead>
                                                <tr>
                                                    <td>ID</td>
                                                    <td>N. Mesa</td>
