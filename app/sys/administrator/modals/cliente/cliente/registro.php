						...
						<div class='col-lg-6'>
							...
							<table width='100%'>
								<tr>
									...
									<td>
										<select  name='slctPlan' id='slctPlan' class='form-control select2' onChange="calcularPago(); acciones_select()" style='width:100%'></select>
									</td>
								</tr>
								<tr>
									<td>
							...
							<table class='table'>
								<tr>
									<th colspan='2'>Resumen de pago</th>
								</tr>
								<tr>
