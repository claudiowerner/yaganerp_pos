			...
			<div class='modal-body'>
                <table id='productos2' class='table'>
					...
					<tr id=codBarraEditar>
						...
						<td>
							<input type='text' id='txtCodBarraEditar' name='nomProdEditar' class='form-control'>
						</td>
					</tr>
					<tr>
						...
						<tr>
							...
							<td>
								<select class='form-control' id='listCatEditar' required></select>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input type='number' name='cantidad' id='valorVentaEditar' class='form-control' required>
							</td>
						</tr>
						<tr>
