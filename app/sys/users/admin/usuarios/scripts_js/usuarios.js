      ...
      {"data":"fecha_reg"},
      {
        "data": null,
          "render": function (data, type, row) {
            ...
            <button type='submit' id='btnEliminar' class='btn btn-danger' style='margin: 2px'  onClick="eliminarUsuario(${data.id}, ${data.id_tipo_usuario}, '${data.user}')"><i class='fa fa-trash' aria-hidden='true'></i></span></button>`;
          }
      }
    ],
