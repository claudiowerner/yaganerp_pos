<?php
  //modal crear clave
  echo '<div class="modal fade" id="crearClave" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
...
//modal configuracion de porcentaje de ganancia

echo '<div class="modal fade" id="modalConfGanancia" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="tipoVenta">Configurar información de las cuentas de ventas</h5>
