          ...
          "columns":[
            ...
            {"data":"fecha_registro"},
            {
                ...
                "mRender": function(data, type, value) {
                  ...
                  return `<button type="submit" id="btnEditar" class="btn btn-primary" onClick="editarCliente('${value.id}','${value.rut}','${value.nombre}','${value.apellido}', '${value.telefono}')" ><i class='fa fa-edit' aria-hidden='true'></i></button>
